...
class Course_Offering_ds extends Course_Offering{
    ...
    public function insert($course_offering_id, $course_term, $course_year) {
        $qry = 'INSERT INTO CourseOffering (course_offering_id, course_term, course_year) VALUES (?, ?, ?, ?)';
        $stmt = $this->conn->prepare($qry);
    
        $stmt->bind_param('iisi', $course_offering_id, $course_term, $course_year);
